...
def train_autoencoder(img_size: Tuple[int, int, int], data_root_folder: str) -> None:
    ...
    trainer = pl.Trainer(gpus=1, default_root_dir=os.path.join(data_root_folder, "autoencoder_logs"))
...
if __name__ == "__main__":
    ...
    train_autoencoder(img_size, args.data_root_folder)
