...
def train_lstm(img_size: Tuple[int, int, int], root_folder: str, trained_encoder_path: str) -> None:
    ...
    model = CAELSTMSeq()
    trainer = pl.Trainer(gpus=1, default_root_dir=os.path.join(root_folder, "lstm_logs"))
...
if __name__ == "__main__":
    ...
    train_lstm(img_size, args.root_folder, args.trained_encoder_path)
